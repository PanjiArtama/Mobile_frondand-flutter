...
import 'package:flutter_applicationnn/folder/listFotograferProvider.dart';

import 'package:flutter_applicationnn/folder/pembayaran.dart';
import 'package:provider/provider.dart';

class ListFotograferScreen extends StatefulWidget {
  const ListFotograferScreen({super.key});

  @override
  State<ListFotograferScreen> createState() => _ListFotograferScreenState();
}

class _ListFotograferScreenState extends State<ListFotograferScreen> {
  @override
  void initState() {
    Future.microtask(() {
      Provider.of<ListFotograferProvider>(context, listen: false).initialData();
    });
    super.initState();
  }
  ...
  menuList(BuildContext context) {
    final prov = Provider.of<ListFotograferProvider>(context);
