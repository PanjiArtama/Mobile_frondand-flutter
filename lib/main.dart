...
import 'package:flutter_applicationnn/folder/listDekorProvider.dart';
...
void main() {
  runApp(MultiProvider(providers: [
    ChangeNotifierProvider(create: (_) => ListGedungProvider()),
    ChangeNotifierProvider(create: (_) => ListDekorProvider()),
    ChangeNotifierProvider(create: (_) => ListFotograferProvider())
  ], child: MyApp()));
}
